      ...
      <Animated.View style={[styles.background, animatedStyle]}>
        {colorScheme === "dark" ? (
          <Image
            source={
              width < 600
                ? require("./img/gaus.png")
                : require("./img/gauslg.png")
            }
          ...
          <Image
            source={
              width < 600
                ? require("./img/gauswt.png")
                : require("./img/gauslgwt.png")
            }
            style={styles.bgImage}
          />
        )}
        ...
        {step === 0 && Platform.OS === "web" ? (
          <ScrollView ref={scrollRef} style={{ flex: 1 }}>
            <View style={{ padding: 20 }}>
              ...
              <TouchableOpacity
                onPress={() => scrollToSection("About Us")}
              ...
              >
                <View
                  style={{
                    marginBottom: large ? 20 : 0,
                    maxWidth: large ? 600 : "100%",
                    padding: 32,
                  }}
                >
                  <ThemedText
                    style={{ marginVertical: 20, color: Colors.primary }}
                    type="title"
                  >
                    About Us
                  </ThemedText>
                  <ThemedText type="default">
                    We are a team of passionate educators and developers
                    dedicated to revolutionizing the way students learn.
                  </ThemedText>
                  <ThemedText type="default">
                    Our mission is to create an engaging and personalized
                    learning experience that empowers students to reach their
                    full potential.
                  </ThemedText>
                </View>
                <View
              ...
              <View
                style={{ padding: 32, display: "flex", alignItems: "center" }}
              >
                <ThemedText
                ...
                <ThemedText type="default">
                  We believe quality education should be accessible. Start for
                  free and upgrade only when you're ready, with generous offers
                  for individuals, teams and institutions.
                </ThemedText>
              </View>
              <PricingSwitcher
                selected={planType}
                onPress={(type) => setPlanType(type)}
              />
              {planType === "individual" ? (
                <View
                  style={{
              ...
              >
                <View style={{ maxWidth: large ? 600 : "100%" }}>
                  <Image
                    source={require("./img/app_mockup.webp")}
                    style={{
                      maxWidth: "100%",
                      maxHeight: 500,
                      resizeMode: "contain",
                ...
                <View
                  style={[
                    ...
                    {
                      marginTop: large ? 0 : 20,
                      maxWidth: large ? 600 : "100%",
                      alignItems: large ? "flex-start" : "center",
                    },
                  ]}
                >
                  <ThemedText style={{ color: Colors.primary }} type="title">
                    Download the App
                  </ThemedText>
                  <ThemedText
                    ...
                    type="default"
                  >
                    Get the full experience on your phone or tablet. Learn
                    anywhere, anytime.
                  </ThemedText>
                  <TouchableOpacity
                    style={[
                      styles.cta,
                      { marginHorizontal: large ? 0 : "auto" },
                    ]}
              ...
              >
                <View style={{ width: large ? 600 : "100%" }}>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.cta,
                      { marginHorizontal: large ? 0 : "auto", width: "100%" },
                    ]}

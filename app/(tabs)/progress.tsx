...
export default function ProgressPage() {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      ...
      setActivitiesDB(activitiesResult);
    };
    fetchActivities();
  }, [getActivities]);
  ...
  function filterActivities(type: string) {
    ...
    } else setActivities(activitiesDB);
  }
        ...
        <View style={styles.container}>
          <View>
            ...
            <ScrollView style={[styles.filterButtons]} horizontal>
              ...
              />
              <IconTextButton
                onPress={() => filterActivities("Flashcards")}
              ...
              />
              <IconTextButton
                onPress={() => filterActivities("Lesson")}
